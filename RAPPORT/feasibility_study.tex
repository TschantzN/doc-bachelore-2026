...
\begin{itemize}
    ...
    liées au démon \texttt{wpa\_supplicant} (\texttt{config\_ssid.h}), indique que la fonctionnalité 
...
Le relais radio, configuré en point d'accès (AP) au sol pour réceptionner le flux, 
...
\begin{itemize}
    ...
    La preuve formelle d'une injection manuelle du LDPC a donc été écartée de l'implémentation finale. 
...
LDPC en raison de la machine à états du standard Wi-Fi, l'accès au code source du SDK FreeRTOS et 
