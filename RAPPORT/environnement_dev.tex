...
l'initialisation du HAL (Hardware Abstraction Layer).
...
d'émission. Bien que cette configuration soit réservée à un cadre expérimental, elle était 
indispensable pour ce travail de Bachelor afin de mesurer les performances brutes et réelles de 
la puce (ramenant la latence radio autour de 3 à 5 ms, testée par ping), indépendamment des 
limitations légales.