...
très élevé, dépassant les 300 ms. 
...
\end{itemize}
\subsubsection{Précisions sur les paramètres de pipeline}
...
différentielle a prouvé qu'au moins une partie de la latence "fantôme" provenait de l'Image Signal 
...
l'encodeur, nous ferons l'hypothèse qu'il en conserve 4. Mathématiquement, pour un capteur configuré pour 
