...
(pipelines) ont été développées et adaptées selon l'architecture matérielle cible (Nvidia ou Raspberry Pi). 
Elles intègrent de nombreux paramètres spécifiques qui seront détaillés ci-après :
