...
en flux tendu, ce qui annule la latence induite par les retransmissions au prix, toutefois, de potentielles pertes 
de paquets.
...
et de la fréquence d'échantillonnage (réquence de capture d'image), le poids moyen d'une image vidéo compressée se calcule ainsi :
