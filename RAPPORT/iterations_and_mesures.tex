...
Ces mesures physiques ont mis en évidence un comportement inattendu : alors que le module de réception au sol EKH19 émet (ping de l'EKH05) bien au-dela de la
la limite européen de \textbf{14 dBm} à une puissance de \textbf{20 dBm}, le module d'émission embarqué (EKH05) s'est avéré bridé à une puissance d'émission de seulement 
