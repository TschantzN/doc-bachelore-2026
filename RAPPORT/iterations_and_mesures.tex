...
La forte compression appliquée (Qualité JPEG fixée au niveau 8) et la résolution de 320x240 pixels représentent le « sweetspot » trouvé empiriquement pour maintenir un débit de 1.53 Mbps sans perte de trames. En extérieur, le traitement d'image de l'ISP (lissage automatique du bruit numérique) compense la réduction de résolution spatiale. L'image résultante conserve une netteté suffisante pour distinguer précisément les obstacles en vol.

Afin d'illustrer les performances visuelles du système face à la réalité du terrain, un comparatif direct a été mené entre les captures d'écran du flux vidéo compressé reçu et des clichés de référence pris simultanément avec un smartphone :
...
\begin{figure}[!htp]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{Flux FPV : Détail d'une plate-bande}
...
\begin{figure}[!htp]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{Flux FPV : Obstacles au sol}
...
Cette approche par comptage de motifs différentiels élimine tout biais lié au rafraîchissement des dalles 
et offre une précision de lecture nettement supérieure à celle d'un chronomètre numérique classique, dont les 
chiffres flous induits par la rémanence empêchent une quantification fiable. Pour obtenir un profil statistique 
...
L'analyse statistique de ces 79 mesures de terrain (voir Figure \ref{fig:latency_plot}) révèle des performances remarquables, parfaitement stables à travers plusieurs captures successives :
\begin{itemize}
