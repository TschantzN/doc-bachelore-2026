...
La station de réception (RX) s'appuiera probablement sur le modèle EKH19 afin de pouvoir exploiter le système d'exploitation OpenWrt. 
Quant au Transmetteur (TX), il sera probablement basé sur le modèle EKH05 piloté par FreeRTOS.
...
& \textbf{E 8 :} L'architecture logicielle doit être compatible avec les différentes variantes de 
modules basés sur la puce MM8108 (EKH05 et EKH19).\\
\end{longtable}
