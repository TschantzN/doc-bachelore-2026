...
\begin{itemize}
    ...
    combiné à une réception en mode moniteur (Monitor Mode) côté RX (RTOS).
...
& \textbf{E 8 :} L'architecture logicielle doit être compatible avec les différentes variantes de modules basés sur la puce MM8108. \\
\end{longtable}
